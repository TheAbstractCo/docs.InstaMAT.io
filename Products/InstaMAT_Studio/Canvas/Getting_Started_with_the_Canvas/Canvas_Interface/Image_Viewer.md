...
![Image Viewer Numbered](/instamat_studio/canvas/image_viewer_numbered.png =600x){.align-right} The Image Viewer is divided up into three parts: The Image View, the Toolbar, and the Image Viewer Status Bar.
